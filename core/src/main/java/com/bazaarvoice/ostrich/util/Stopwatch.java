package com.bazaarvoice.ostrich.util;
...
/*
 * NOTE: this class is directly copied from Guava 17.0.
 *       The Stopwatch API has changed between Guava 16.0.1 and 17.0 (as its marked as @Beta still)
 *       We have copied it here in order to facilitate compatibility with older Guava versions: 14.0.1, 15.0, 16.0.1, 17.0
 */
/**
 ...
 * {@link #createUnstarted(com.google.common.base.Ticker)} or {@link #createStarted(com.google.common.base.Ticker)} to
